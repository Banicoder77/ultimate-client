...
public class Capes {
    private static final String CAPE_OWNERS_URL = "https://github.com/Banicoder77/ultimate-client/api/capeowners";
    private static final String CAPES_URL = "https://github.com/Banicoder77/ultimate-client/api/capes";
    ...
    @PreInit(dependencies = UltimateExecutor.class)
    public static void init() {
        ...
        UltimateExecutor.execute(() -> {
            ...
            Stream<String> lines = Http.get(CAPE_OWNERS_URL)
                .exceptionHandler(e -> UltimateClient.LOG.error("Could not load capes: {}",  e.getMessage()))
                .sendLines();
            if (lines != null) {
                lines.forEach(s -> {
        ...
        UltimateClient.EVENT_BUS.subscribe(Capes.class);
    }
    ...
    private static class Cape {
        ...
        public Cape(String name) {
            this.identifier = UltimateClient.identifier("capes/" + COUNT++);
            this.name = name;
        }
        ...
        public void download() {
            ...
            UltimateExecutor.execute(() -> {
                try {
                    ...
                    UltimateClient.LOG.error("Failed to download cape '{}'", name, e);
                }
            });
        }
