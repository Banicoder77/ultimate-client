...
import ultimatedevelopment.ultimateclient.mixininterface.IChatHud;
...
public class ChatUtils {
    ...
    public static void init() {
        PREFIX = Text.empty()
            ...
            .append("[")
            .append(Text.literal("Ultimate").setStyle(Style.EMPTY.withColor(TextColor.fromRgb(UltimateClient.ADDON.color.getPacked()))))
            .append("] ");
    }

    public static Text getUltimatePrefix() {
        return PREFIX;
    }

    /**
     * Registers a custom prefix to be used when calling from a class in the specified package. When null is returned from the supplier the default Ultimate prefix is used.
     */
    ...
    public static MutableText formatCoords(Vec3d pos) {
        ...
        if (BaritoneUtils.IS_AVAILABLE) {
            Style style = coordsText.getStyle().withFormatting(Formatting.BOLD)
                ...
                .withClickEvent(new UltimateClickEvent(
