...
public class ContainerTooltipComponent implements TooltipComponent, UltimateTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = UltimateClient.identifier("textures/container.png");
