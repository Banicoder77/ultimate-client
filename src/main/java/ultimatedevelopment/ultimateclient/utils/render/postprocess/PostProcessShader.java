...
public abstract class PostProcessShader {
    ...
    protected PostProcessShader(RenderPipeline pipeline) {
        ...
        this.framebuffer = new SimpleFramebuffer(UltimateClient.NAME + " PostProcessShader " + this.getClass().getSimpleName(), mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight(), true);
    }
    ...
    private static final DynamicUniformStorage<UniformData> UNIFORM_STORAGE = new DynamicUniformStorage<>("Ultimate - Post UBO", UNIFORM_SIZE, 16);
