...
package ultimatedevelopment.ultimateclient.utils;
...
import ultimatedevelopment.ultimateclient.mixin.*;
import ultimatedevelopment.ultimateclient.mixininterface.IMinecraftClient;
import ultimatedevelopment.ultimateclient.settings.StatusEffectAmplifierMapSetting;
...
import ultimatedevelopment.ultimateclient.utils.player.EChestMemory;
import ultimatedevelopment.ultimateclient.utils.render.PeekScreen;
...
import ultimatedevelopment.ultimateclient.utils.world.BlockEntityIterator;
import ultimatedevelopment.ultimateclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        UltimateClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            UltimateClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
