...
import ultimatedevelopment.ultimateclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "ultimatedevelopment.ultimateclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            UltimateClient.LOG.error("Error loading the mixin plugin", e);
        }
