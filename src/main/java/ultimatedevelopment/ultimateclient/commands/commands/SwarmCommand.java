...
import ultimatedevelopment.ultimateclient.systems.modules.misc.swarm.SwarmConnection;
import ultimatedevelopment.ultimateclient.systems.modules.misc.swarm.SwarmWorker;
import ultimatedevelopment.ultimateclient.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new UltimateClickEvent(".swarm join confirm"))
                                    ));
