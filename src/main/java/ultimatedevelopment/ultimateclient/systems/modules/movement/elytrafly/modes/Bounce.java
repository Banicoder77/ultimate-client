...
package ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly.modes;
...
import ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly.ElytraFlightMode;
    ...
    private static boolean startGliding(ClientPlayerEntity player) {
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            if (LivingEntity.canGlideWith(player.getEquippedStack(equipmentSlot), equipmentSlot)) {
                UltimateClient.mc.executeSync(player::startGliding);
                return true;
            }
        }
