...
package ultimatedevelopment.ultimateclient.systems.modules.movement.speed.modes;
...
import ultimatedevelopment.ultimateclient.systems.modules.movement.Anchor;
import ultimatedevelopment.ultimateclient.systems.modules.movement.speed.SpeedMode;
import ultimatedevelopment.ultimateclient.systems.modules.movement.speed.SpeedModes;
...
public class Strafe extends SpeedMode {
    ...
    public static Vector2d transformStrafe(double speed) {
        float forward = Math.signum(UltimateClient.mc.player.input.getMovementInput().y);
        float side = Math.signum(UltimateClient.mc.player.input.getMovementInput().x);
        float yaw = UltimateClient.mc.player.getLerpedYaw(UltimateClient.mc.getRenderTickCounter().getTickProgress(true));
