...
package ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly;
...
import ultimatedevelopment.ultimateclient.mixin.AbstractBlockAccessor;
...
import ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly.modes.Packet;
import ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly.modes.Pitch40;
import ultimatedevelopment.ultimateclient.systems.modules.movement.elytrafly.modes.Vanilla;
import ultimatedevelopment.ultimateclient.systems.modules.player.ChestSwap;
import ultimatedevelopment.ultimateclient.systems.modules.player.Rotation;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        UltimateClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        UltimateClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        UltimateClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        UltimateClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
