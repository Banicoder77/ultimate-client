...
import ultimatedevelopment.ultimateclient.renderer.MeshBuilder;
...
import ultimatedevelopment.ultimateclient.utils.render.MeshBuilderVertexConsumerProvider;
import ultimatedevelopment.ultimateclient.utils.render.RenderUtils;
import ultimatedevelopment.ultimateclient.utils.render.SimpleBlockRenderer;
...
public class StorageESP extends Module {
    ...
    public StorageESP() {
        ...
        mesh = new MeshBuilder(UltimateRenderPipelines.WORLD_COLORED);
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (mode.get() == Mode.Shader && count > 0) {
            MeshRenderer.begin()
                ...
                .pipeline(UltimateRenderPipelines.WORLD_COLORED)
