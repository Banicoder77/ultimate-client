...
import ultimatedevelopment.ultimateclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        UltimateClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        UltimateClient.EVENT_BUS.unsubscribe(staticListener);
    }
}
