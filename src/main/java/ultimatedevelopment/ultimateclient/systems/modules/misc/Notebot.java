...
import ultimatedevelopment.ultimateclient.utils.notebot.NotebotUtils;
import ultimatedevelopment.ultimateclient.utils.notebot.decoder.SongDecoder;
import ultimatedevelopment.ultimateclient.utils.notebot.decoder.SongDecoders;
import ultimatedevelopment.ultimateclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import ultimatedevelopment.ultimateclient.utils.notebot.song.Note;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = UltimateClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    UltimateClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
