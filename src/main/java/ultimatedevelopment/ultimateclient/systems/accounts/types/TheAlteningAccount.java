...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    public boolean fetchInfo() {
        ...
        try {
            ...
            UltimateClient.LOG.error("Invalid TheAltening credentials.");
            return false;
        } catch (Exception e) {
            UltimateClient.LOG.error("Failed to fetch info for TheAltening account!");
            return false;
        }
    }
    ...
    public boolean login() {
        ...
        try {
            ...
            UltimateClient.LOG.error("Failed to login with TheAltening.");
            return false;
        }
    }
    ...
    private WaybackAuthLib getAuth() {
        ...
        auth.setPassword("Ultimate on Crack!");
