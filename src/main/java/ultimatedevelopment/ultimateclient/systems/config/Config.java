...
package ultimatedevelopment.ultimateclient.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenCredits = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Ultimate credits on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Ultimate splash texts on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", UltimateClient.VERSION.toString());
