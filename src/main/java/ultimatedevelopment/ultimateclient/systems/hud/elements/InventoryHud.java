...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = UltimateClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = UltimateClient.identifier("textures/container-transparent.png");
