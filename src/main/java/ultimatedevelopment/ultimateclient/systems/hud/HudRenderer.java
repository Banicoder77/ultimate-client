...
import ultimatedevelopment.ultimateclient.renderer.*;
import ultimatedevelopment.ultimateclient.renderer.text.CustomTextRenderer;
import ultimatedevelopment.ultimateclient.renderer.text.Font;
import ultimatedevelopment.ultimateclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
    ...
    private HudRenderer() {
        UltimateClient.EVENT_BUS.subscribe(this);
    }
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(UltimateRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(UltimateRenderPipelines.UI_TEXT);
