...
import ultimatedevelopment.ultimateclient.gui.widgets.WHorizontalSeparator;

public class WUltimateHorizontalSeparator extends WHorizontalSeparator implements UltimateWidget {
    public WUltimateHorizontalSeparator(String text) {
        super(text);
    }
