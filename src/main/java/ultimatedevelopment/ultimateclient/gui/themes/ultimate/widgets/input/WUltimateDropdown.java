...
public class WUltimateDropdown<T> extends WDropdown<T> implements UltimateWidget {
    public WUltimateDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements UltimateWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            UltimateGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements UltimateWidget {
        @Override
