...
public class GuiDebugRenderer {
    ...
    private final MeshBuilder mesh = new MeshBuilder(UltimateRenderPipelines.WORLD_COLORED_LINES);
    ...
    public void render(WWidget widget) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(UltimateRenderPipelines.WORLD_COLORED_LINES)
            .mesh(mesh)
            .end();
    }
    ...
    public void mouseReleased(WWidget widget, Click click, int i) {
        ...
        UltimateClient.LOG.info("{} {}", widget.getClass(), i);
