...
import ultimatedevelopment.ultimateclient.gui.renderer.operations.TextOperation;
import ultimatedevelopment.ultimateclient.gui.renderer.packer.GuiTexture;
import ultimatedevelopment.ultimateclient.gui.renderer.packer.TexturePacker;
import ultimatedevelopment.ultimateclient.gui.widgets.WWidget;
import ultimatedevelopment.ultimateclient.renderer.Renderer2D;
import ultimatedevelopment.ultimateclient.renderer.Texture;
...
import static ultimatedevelopment.ultimateclient.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(UltimateClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(UltimateClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(UltimateClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(UltimateClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(UltimateClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(UltimateClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(UltimateClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(UltimateClient.identifier("textures/icons/gui/paste.png"));
