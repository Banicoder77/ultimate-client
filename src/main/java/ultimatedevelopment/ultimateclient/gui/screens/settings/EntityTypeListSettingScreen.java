...
import ultimatedevelopment.ultimateclient.settings.EntityTypeListSetting;
    ...
    private void addEntityType(WTable table, WCheckbox tableCheckbox, EntityType<?> entityType, List<Item> spawnEggItems) {
        ...
        if (stack != null) table.add(theme.item(stack));
            ...
            if (EMPTY_SPAWN_EGG_TEXTURE == null) {
                EMPTY_SPAWN_EGG_TEXTURE = Texture.readResource("/assets/ultimate-client/textures/empty_spawn_egg.png", false, FilterMode.NEAREST);
            }
